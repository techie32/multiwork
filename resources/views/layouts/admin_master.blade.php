...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand">MultiStep</a>
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseProducts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{ url('add-new-mobile') }}">New Mobile</a>
                            ...
                            <div class="collapse" id="collapsecoupon" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{ url('add-new-couponcode') }}">New Coupon</a>
                                    <a class="nav-link" href="{{ route('all-coupon') }}">Available Coupon</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapsebooking" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{ route('all-booking') }}">Booking</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseschedule" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{ url('timing-manage') }}">Time Manage</a>
                                </nav>
                            </div>
